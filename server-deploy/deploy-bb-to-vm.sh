...
#
# Pattern:
#   - Rebuild main.js (sbt fullLinkJS) in this BB workspace.
#   - scp main.js → /opt/cwo/BB/target/scala-2.13/cthulhu-wars-solo-hrf-opt/main.js
#   - Also copy to /opt/cwo/BB/main.js (root-level reference).
#   - scp index.html → /opt/cwo/BB/index.html, with cache tag bumped.
