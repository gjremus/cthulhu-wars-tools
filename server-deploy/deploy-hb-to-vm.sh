...
#
# Pattern:
#   - Rebuild main.js (sbt fullLinkJS) in this HB workspace.
#   - scp main.js → /opt/cwo/HB/target/scala-2.13/cthulhu-wars-solo-hrf-opt/main.js
#   - Also copy to /opt/cwo/HB/main.js (root-level reference).
#   - scp index.html → /opt/cwo/HB/index.html, with cache tag bumped.
...
deploy_lock_acquire "hb" "deploy-hb" || exit 1
...
VERIFY_URL="https://cwo.freeddns.org/HB/"
